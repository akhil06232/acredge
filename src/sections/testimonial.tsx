...
const testimonials = [
	{
		name: 'John Doe',
		image: 'https://randomuser.me/api/portraits/men/32.jpg',
		text: 'ACREDGE made selling my house a breeze! Their expert guidance and personalized service were top-notch.',
		type: 'Seller',
	},
	{
		name: 'Jane Smith',
		image: 'https://randomuser.me/api/portraits/women/44.jpg',
		text: 'I was amazed at how quickly my house sold with ACREDGE. Highly recommended!',
		type: 'Buyer',
	},
	{
		name: 'Samuel Green',
		image: 'https://randomuser.me/api/portraits/men/54.jpg',
		text: 'The team at ACREDGE provided excellent service and support throughout the selling process.',
		type: 'Seller',
	},
	{
		name: 'John Doe',
